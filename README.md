...
helper read-only reports (ports in use, sonarr season fragmentation, tautulli watch history) live in [`scripts/`](scripts/) and are documented in [scripts/README.md](scripts/README.md).
